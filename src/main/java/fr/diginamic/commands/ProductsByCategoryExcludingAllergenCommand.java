...
/**
 * This command retrieves the top products within a category while excluding a specific allergen.
 */
public class ProductsByCategoryExcludingAllergenCommand implements Command{
    ...
    public ProductsByCategoryExcludingAllergenCommand(ProductRepository repository, Scanner scanner) {
        System.out.println("5. Display the top 10 highest-rated products in a category without a given allergen.");
